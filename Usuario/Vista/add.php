 ...
 <header class="app-header fixed-top">
  ...
  <path d="M5.255 5.786a.237.237 0 0 0 .241.247h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286zm1.557 5.763c0 .533.425.927 1.01.927.609 0 1.028-.394 1.028-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94z"/>
      ...
      <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
          ...
          <div class="row g-3 mb-4 align-items-center justify-content-between">
            <div class="col-auto">
                  <h1 class="app-page-title mb-0">Agregar Usuario:</h1>
            </div>
    ...
    <div class="col">
        ...
        <input placeholder="Jhonn Jairo" type="text" name="nombreUser" id="nombreUser">
        <div class="error" id="nombreUserErr"></div>
    </div>

    <div class="col">
        <label for="apellidoUser" class="form-label mt-2">Apellidos:</label>
        <input placeholder="Díaz Rodriguez" type="text" name="apellidoUser" id="apellidoUser">
    ...
    <div class="col">
        ...
        <input type="text" name="NumDocumento" placeholder="1024603445" id="NumDocumento">
        <div class="error" id="NumDocumentoErr"></div>
    </div>

    <div class="col">
        <label for="FechaNacimiento" class="form-label mt-2">Fecha de Nacimiento:</label>
        <input type="date" class="form-date" name="FechaNacimiento" id="FechaNacimiento" min="1920-01-01" max="2018-01-01">
...
<div class="row">
    <div class="col">
        ...
        <input type="text" placeholder="Extension@dominio.com" name="correoUser" id="correoUser">
...
<div class="row">
    <div class="col">
        ...
        <input type="text" placeholder="3003465789" name="telefono" id="telefono">
        <div class="error" id="telefonoErr"></div>
    </div>

    <div class="col">
        <label for="direccionUser" class="form-label mt-2">Dirección:</label>
        <input type="text" placeholder="Tv 33 54 b sur" name="direccionUser" id="direccionUser">
...
<div class="row">
  ...
  <script src="https://kit.fontawesome.com/2c36e9b7b1.js" crossorigin="anonymous"></script>
    ...
    <script type="text/javascript" src="../../assets/js/validacionAddU.js"></script>
