...
try {
    ...
    $mail->Subject = ''.$nombre.' Quiere registrarse';
                ...
                <tr>
                  <td style="padding:35px 30px 11px 30px;font-size:0;background-color:#ffffff;border-bottom:1px solid #f0f0f5;border-color:rgba(201,201,207,.35);">
                    ...
                    <div class="col-lge" style="display:inline-block;width:100%;max-width:395px;vertical-align:top;padding-bottom:20px;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
                              ...
                              <h2 style="margin:0;">Valida los datos para el registro</h2>
                            
                        <div class="nombre" style=" margin-left: 30px;">
                            <h3><b>Nombre: '.$nombre.'</b></h3>
                            <h3><b>Apellido: '.$apellido.'</b></h3>
                            <h3><b>Tipo de documento: '.$tipoDocumento.'</b></h3>
                            <h3><b>documento: '.$documento.'</b></h3>
                            <h3><b>Fecha de nacimiento: '.$fechaNa.'</b></h3>
                            <h3><b>Correo: '.$correo.'</b></h3>
                            <h3><b>Telefono: '.$telefono.'</b></h3>
                            <h3><b>Direccion: '.$direccion.'</b></h3>
                            <h3><b>Rol: '.$tipoRol.'</b></h3>
                        </div>
                    </div>
                  </td>
                </tr>
    ...
    echo '<script>
    alert("El mensaje no se envio correctamente verifica los datos de:"'.$nombre.'" "'.$apellido.');
    window.history.go(-1);z
    </script>';
}   
