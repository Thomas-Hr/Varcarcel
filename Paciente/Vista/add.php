...
<body class="app">
  ...
  <path fill-rule="evenodd" d="M10 5a2 2 0 1 1-4 0 2 2 0 0 1 4 0zM8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm6 5c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
							        ...
							        <div class="col-auto">
								        <h4 class="app-card-title">Agregar Paciente</h4>
							        </div><!--//col-->
						        </div><!--//row-->
						    </div><!--//app-card-header-->
		...
		<!-- Grupo: Paciente -->
    	<div class="col">
        <label for="idUsuarioFK" class="form-label mt-2">Nombre del Paciente:</label>
        <select name="idUsuarioFK" id="idUsuarioFK">
                  <option>Seleccione...</option>
                  <?php $USEREG=$ModeloPaciente->getPacienteCT();
                  if($USEREG !=null){
        ...
        <input placeholder="72" type="text" name="peso" id="peso">
        ...
        <input placeholder="175" type="text" name="estatura" id="estatura">
        ...
        <textarea type="text" name="antecedentesFamiliares" id="antecedentesFamiliares" placeholder="Escriba aquí los antecedentes familiares, de no haber escriba N/A"></textarea>
...
<script type="text/javascript" src="../../assets/js/validacionPCAdd.js"></script>
</body>
</html>
