...
<body class="app">
  ...
  <path fill-rule="evenodd" d="M10 5a2 2 0 1 1-4 0 2 2 0 0 1 4 0zM8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm6 5c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
                      ...
                      <div class="col-auto">
                        <h4 class="app-card-title">Agregar Enfermedad del Paciente:</h4>
                      </div><!--//col-->
                    </div><!--//row-->
                </div><!--//app-card-header-->
             ...
             <form action="../controlador/editPE.php"  class="row g-3 needs-validation" novalidate method="POST" id="formulario">
                <?php
          if($Regpaciente !=null){
          ...
          ?>
                ...
                <input type="hidden" value="<?= $datos['id'];?>" name="id">
                  <input type="hidden" value="<?= $datos['idPaciente'];?>" name="idPacienteFK">
      
      
             
                  
                  <div class="row">
                <div class="col d-grid gap-2 mb-1">
                  <button type="button" id='addEnfermedad' style="background: #3383FF; color: white;" class="btn btn-primary">Añadir enfermedad</button>
                </div>
              </div>   
            ...
            <div class="invalid-feedback">No puedes dejar este campo sin seleccionar!</div>
                </div>
              </div>
            </div>
                
                
                <div class="col text-center" id='btn-enviar'>
                  <button type="submit" class="btn btn-primary" style="background: #3383FF; color: white;">Registrar Enfermedad</button>
                </div>
