...
<div id="app-sidepanel" class="app-sidepanel"> 
  ...
  <path fill-rule="evenodd" d="M10 5a2 2 0 1 1-4 0 2 2 0 0 1 4 0zM8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm6 5c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
							        ...
							        <div class="col-auto">
								        <h4 class="app-card-title">Agregar Profesional</h4>
							        </div><!--//col-->
						        </div><!--//row-->
						    </div><!--//app-card-header-->
                    ...
                    <form action="../Controlador/add.php" class="row g-3" method="POST" name="Form" onsubmit="return validateForm()">
          
            <div class="row">
            <!-- Grupo: Nombre Profesional -->
            <div class="col-md-6">
                <label for="idUsuarioFK" class="form-label mt-2">Nombre del Profesional:</label>
                <select name="idUsuarioFK" id="idUsuarioFK">
                <option>Seleccione...</option>
                 <?php $USEREG=$ModeloProfesional->getFisioCT();
                 	 if($USEREG !=null){
                  		foreach ($USEREG as $id){ ?>
                 <option value="<?php echo $id['idUsuario']; ?>"><?php echo $id['Nombre'];?></option>
                 <?php
                      }
                   }
                 ?>
                </select>
                <div class="error" id="idUsuarioFKErr"></div>
             </div>

            <!-- Grupo: Tarjeta Profesional -->
            <div class="col-md-6">
                <label for="tarjetaProfesional"  class="form-label mt-2">tarjeta Profesional:</label>
                <input type="text" placeholder="Ejm: 3465654" id="tarjetaProfesional" name="tarjetaProfesional">
            <div class="error" id="tarjetaProfesionalErr"></div>
            </div>

            <!-- Grupo: especialidad profesional -->
            <div class="col-md-12">
                ...
                <?php $USEREG=$ModeloMetodos->getEspecialidad();
                  	if($USEREG !=null){
                  		foreach ($USEREG as $id){ ?>
                <option value="<?=$id['idEspecialidad']; ?>"><?php echo $id['nombreEspecialidad'];?></option>
                <?php
                     }
                   }
                 ?>
            ...
            <div class="col-md-6">
                <label for="HorasT"  class="form-label mt-2">Horas de trabajo:</label>
                <input type="text" name="HorasT" placeholder="Ej: 08:20:00" id="HorasT">
            ...
            <div class="col-md-6">
                ...
                <input type="text" readonly value="Activo" id="estadoMedico" name="estadoMedico">
            </div>
        </div>
    ...
    <script type="text/javascript" src="../../assets/js/validacionPFAdd.js"></script>
