...
$ModeloEsp=new Especialidad();
  $paginas=new Especialidad();
?>
...
<body>
  <?php 
  if (!$_GET) {
     header('Location:especialidad.php?pagina=1');
  }
   ?>
  <div class="sidebar">
  ...
  <div class="home_content">
    <section>
      <h1 class="text">Gestión de especialidades</h1>
    <table  class="tabla">
      <tr class="columtr">
        <th class="izq">ID</th>
        <th>Especialidad</th>
       ...
       <tr class="columtrDatos">
        ...
        <td><?php echo $especialidad ['estadoEspecialidad']?></td>
        <td><a class="boton" href="edit.php?id=<?php echo $especialidad['idEspecialidad'] ?>"><i class="far fa-edit"></td>
        <td><a class="boton" href="delete.php?id=<?php echo $especialidad['idEspecialidad'] ?>"><i class="far fa-trash-alt"></td>
      </tr>
      <?php      
...
?>
    ...
    <div class="agregar">
 <a href="add.php">Nuevo Paciente</a>
 </div>
    </section>
