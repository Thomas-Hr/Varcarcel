	  ...
	  <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
					        ...
					        <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
						        <ul class="submenu-list list-unstyled">
							        ...
							        <li class="submenu-item"><a class="submenu-link active" href="Noticias.php">Noticias</a></li>
						        </ul>
					        </div>
					    </li><!--//nav-item-->
					    <li class="nav-item has-submenu">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Gestión noticias:</h1>
				    </div>
				...
				<div class="tab-content" id="orders-table-tab-content">
                    ...
                    <div class="m-2">
                      <a href="add.php" class="btn botonNuevo"><i class="fas fa-plus"></i></a>
         						</div>
                           ...
                           <thead>
                               <tr>
                                   ...
                                   <th class="cell">Descricion</th>
                                   <th class="cell">Contenido</th>
                         ...
                         ?>
                               ...
                               <tr>
                               <td><?php echo $not ['idNoticia']?></td>
                 <td class="cell"><?php echo $not['titulo']?></td>
                 <td class="cell"><?php echo $not['descripcion']?></td>
				 <td class="cell"><?php echo $not['texto']?></td>
                 <td class="cell"><?php echo $not['imagen']?></td>
                 <td class="cell"><?php echo $not['FechaCreate']?></td>

                 <td class="cell"><a href="edit.php?id=<?php echo $not['idNoticia']?>" class="btn botonEditar btn-sm">Editar</a></td>

                 <td class="cell"><button type="button"  class="btn botonBorrar btn-sm" data-bs-toggle="modal" data-bs-target="#modalBorrar<?=$not['idNoticia']?>">Eliminar</button></td>
               </tr>
               <!-- Modal Borrar-->
              <div class="modal fade" id="modalBorrar<?=$not['idNoticia']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
              <div class="modal-content">
              <div class="modal-header" style="background: #2C71B7;">
              <h5 class="modal-title" style="color: white;" id="exampleModalLabel">Borrar Noticia #<?php echo $not['idNoticia']; ?></h5>
              ...
              <p>Está a punto borrar esta noticia, deseas continuar?
              <input type="hidden" name="idNoticia" value="<?php echo $not['idNoticia']; ?>">
              </p>
