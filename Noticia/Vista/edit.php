...
$id=$_GET['id'];
$regnot=$ModeloNoticia->getById($id);
...
<body class="app">
 <header class="app-header fixed-top">
  ...
  <path d="M5.255 5.786a.237.237 0 0 0 .241.247h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286zm1.557 5.763c0 .533.425.927 1.01.927.609 0 1.028-.394 1.028-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94z"/>
      ...
      <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
          ...
          <div class="row g-3 mb-4 align-items-center justify-content-between">
            <div class="col-auto">
                  <h1 class="app-page-title mb-0">Editar Noticia:</h1>
            </div>
    ...
    <form action="../../noticia/controlador/edit.php" method="post" class="row g-2" enctype="multipart/form-data" name="Form" onsubmit="return validateFormNT()">

 <?php

                     
                         if ($regnot !=null) {
                         foreach ($regnot as $not) {
                         ?>
...
<!-- Grupo: titulo -->  
  <div class="col">
    ...
    <input type="text" id="titulo" name="titulo" value="<?php echo $not['titulo'] ?>">
...
<textarea  type="text" id="descripcion" name="descripcion"><?php echo $not['descripcion'] ?></textarea>
...
<textarea  type="text" id="texto" name="texto"><?php echo $not['texto'] ?></textarea>
...
<input type="file" id="imagen" name="imagen" accept="image/png, .jpeg, .jpg, image/gif" value="<?php echo $not['imagen'] ?>">
...
<input type="hidden" class="form-control" id="FechaC" name="FechaCreate" value="<?php echo $not['FechaCreate'] ?>">
</div>
</div>
