...
function validateForm() {
    ...
    var estadoMedico = document.Form.estadoMedico.value;
    
    var tarjetaProfesionalErr = idEspecialidadFKErr = HorasTErr = estadoMedicoErr = true;
    ...
    /*Grupo Estado Medico*/
    if(estadoMedico == "Seleccione...") {
        printError("estadoMedicoErr", "Por favor no dejar el campo vacío");
        var elem = document.getElementById("estadoMedico");
            elem.classList.add("input-4");
            elem.classList.remove("input-3");
    } else {
        printError("estadoMedicoErr", "");
        estadoMedicoErr = false;
        var elem = document.getElementById("estadoMedico");
            elem.classList.add("input-3");
            elem.classList.remove("input-4");
    }
    ...
    if((tarjetaProfesionalErr || idEspecialidadFKErr || HorasTErr || estadoMedicoErr) == true) {
       return false;
