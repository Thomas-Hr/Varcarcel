...
function validateForm() {
    ...
    var idUsuarioFKErr = estadoPacienteErr = pesoErr = estaturaErr = antecedentesFamiliaresErr = true;
    ...
    if((idUsuarioFKErr || estadoPacienteErr || pesoErr || estaturaErr || antecedentesFamiliaresErr) == true) {
       return false;
