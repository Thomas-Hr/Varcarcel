...
function validateForm() {
    ...
    var nombreUserErr = apellidoUserErr = tipoDocumentoErr = NumDocumentoErr = FechaNacimientoErr = correoUserErr  = telefonoErr = direccionUserErr = tipoRolErr = true;
    ...
    if((nombreUserErr || apellidoUserErr || tipoDocumentoErr || correoUserErr || NumDocumentoErr || FechaNacimientoErr || telefonoErr || direccionUserErr || tipoRolErr) == true) {
       return false;
